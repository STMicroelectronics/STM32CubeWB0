...
#define CONFIG_DATA_MIN_CONN_INTERVAL               (0x50) /**< Minimum connection interval below 7.5 ms */
...
#define CONFIG_DATA_MIN_CONN_INTERVAL_LEN       (2)
...
#define SM_ENCRYPTION_FAILED_MISSING_LOCAL_LTK  (0x03)
#define SM_ENCRYPTION_FAILED_MISSING_PEER_LTK   (0x04)
#define SM_ENCRYPTION_NOT_SUPPORTED_BY_REMOTE   (0x05)
/**
 * @}
 */
