...
In this example, after start-up, SYSCLK is configured to the max frequency using the PLL with HSE as clock source.
...
### <b>Directory contents</b>
  ...
  - RTC/RTC_Alarm_Init/Inc/stm32wb0x_it.h     Interrupt handlers header file
  ...
  - RTC/RTC_Alarm_Init/Src/stm32wb0x_it.c     Interrupt handlers
  - RTC/RTC_Alarm_Init/Src/main.c             Main program
  - RTC/RTC_Alarm_Init/Src/system_stm32wb0x.c STM32WB0x system source file
