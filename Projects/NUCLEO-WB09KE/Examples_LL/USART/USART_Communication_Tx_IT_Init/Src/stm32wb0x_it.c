...
/**
  ******************************************************************************
  * @file    Examples_LL/USART/USART_Communication_Tx_IT_Init/Src/stm32wb0x_it.c
...
void USART1_IRQHandler(void)
{
  ...
  {
    /* TXE flag will be automatically cleared when writing new data in $TDREGISTERUC$ register */
