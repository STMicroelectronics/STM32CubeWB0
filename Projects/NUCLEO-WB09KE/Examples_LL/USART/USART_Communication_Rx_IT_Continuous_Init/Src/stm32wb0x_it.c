...
/**
  ******************************************************************************
  * @file    Examples_LL/USART/USART_Communication_Rx_IT_Continuous_Init/Src/stm32wb0x_it.c
...
void USART1_IRQHandler(void)
{
  ...
  /* Check RXNE flag value in $STATUSREGISTERUC$ register */
  if (LL_USART_IsActiveFlag_RXNE(USART1) && LL_USART_IsEnabledIT_RXNE(USART1))
  {
    /* RXNE flag will be cleared by reading of $RDREGISTERUC$ register (done in call) */
