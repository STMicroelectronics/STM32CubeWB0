...
HTS_APP_ConnHandleNotEvt_t HTSHandleNotification;

static const char a_GapDeviceName[] = {  'H', 'e', 'a', 'l', 't', 'h', 'T', 'h', 'e', 'r', 'm', 'o', 'm', 'e', 't', 'e', 'r', ' ', 'S', 'e', 'n', 's', 'o', 'r' }; /* Gap Device Name */
...
uint8_t a_AdvData[] =
{
  ...
  6, AD_TYPE_COMPLETE_LOCAL_NAME, 'H', 'T', '_', 'X', 'X',  /* Complete name */
  3, AD_TYPE_16_BIT_SERV_UUID_CMPLT_LIST, 0x09, 0x18,
  ...
  case HCI_DISCONNECTION_COMPLETE_EVT_CODE:
    {
      ...
      HTSHandleNotification.EvtOpcode = HTS_DISCON_HANDLE_EVT;
      HTSHandleNotification.ConnectionHandle = p_disconnection_complete_event->Connection_Handle;
      HTS_APP_EvtRx(&HTSHandleNotification);
                                      ...
                                      uint16_t Supervision_Timeout)
{
  ...
  DIS_APP_EvtRx(&DISHandleNotification);
  HTSHandleNotification.EvtOpcode = HTS_CONN_HANDLE_EVT;
  HTSHandleNotification.ConnectionHandle = Connection_Handle;
  HTS_APP_EvtRx(&HTSHandleNotification);
    ...
    case AD_TYPE_MANUFACTURER_SPECIFIC_DATA:
      {
        ...
        p_adv_data[i+6] = FW_ID_HEALTH_THERMO; /* FW ID */
