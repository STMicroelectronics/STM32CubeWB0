...
/* USER CODE BEGIN ConnStatus_t */
  APP_BLE_GENERAL_CONNECTION_SCANNING,
  APP_BLE_ADV_FAST_NON_DISC_WITH_FILTER,
  APP_BLE_LP_CONNECTING_AUTO_CONNECTION,
...
/**
  * Setting this define to 1 will enable advertising at startup.
  * Setting this define to 0 will disable advertising at startup. 
  */
#define STARTUP_ADVERTISING_ENABLE 1

/** 
  * Setting this define to 1 will cause the application to restart advertising after every disconnection.
  * Setting this define to 0 will disable automatic restart of advertising after disconnection. 
  */
#define RESTART_ADVERTISING_AFTER_DISCONNECTION_ENABLE 1
    
/** 
  * Setting this define to 1 will cause the application to restart advertising after every connection.
  * Setting this define to 0 will disable automatic restart of advertising after connection. 
  */
#define RESTART_ADVERTISING_AFTER_CONNECTION_ENABLE 1
