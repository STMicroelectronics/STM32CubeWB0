 ...
 */
#define CFG_PUBLIC_BD_ADDRESS               (0x0280E1AAACCC)
 ...
 */
#define CFG_IO_CAPABILITY                   GAP_IO_CAP_KEYBOARD_DISPLAY
 ...
 */
#define CFG_BLE_NUM_CLT_CONTEXT_MAX                       (0x0002)

#define CFG_BLE_PERIPHERAL_HANDLES_MAX                    (0x0003)
...
typedef enum
{
  ...
  TASK_BUTTON_2_LONG_PRESS,
  TASK_BUTTON_3_LONG_PRESS,
  CFG_TASK_ADV_CANCEL_ID,
  CFG_TASK_SEND_NOTIF_ID,
  CFG_TASK_TERMINATE_ALL_CENTRAL_CONNECTIONS,
  CFG_TASK_TERMINATE_ALL_PERIPHERAL_CONNECTIONS,
  CFG_TASK_CONFIGURE_FILTER_LIST_AND_NEW_ADV,
  CFG_TASK_PERIPHERAL_SECURITY_REQUEST,
  CFG_TASK_START_ADVERTISE,
  CFG_TASK_CONNECTION_REQUEST,
  CFG_TASK_AUTO_CONNECTION_REQUEST,
  CFG_TASK_FILTER_SCAN_REQUEST,
  CFG_TASK_WRITE_ALL_CHAR_ID,
