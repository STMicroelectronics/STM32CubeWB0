...
static void UartCmdExecute(void)
{
  ...
  if(strcasecmp((char const*)CommandString, "SW1") == 0)
  {
    APP_DBG_MSG("SW1 OK\n");
#if (CFG_BUTTON_SUPPORTED == 1)
  ...
  else if (strcasecmp((char const*)CommandString, "SW2") == 0)
  {
    APP_DBG_MSG("SW2 OK\n");
#if (CFG_BUTTON_SUPPORTED == 1)
  ...
  else if (strcasecmp((char const*)CommandString, "SW3") == 0)
  {
    APP_DBG_MSG("SW3 OK\n");
#if (CFG_BUTTON_SUPPORTED == 1)
  ...
  else if(strcasecmp((char const*)CommandString, "SW1_LONG") == 0)
  {
  ...
  else if (strcasecmp((char const*)CommandString, "SW2_LONG") == 0)
  {
  ...
  else if (strcasecmp((char const*)CommandString, "SW3_LONG") == 0)
  {
