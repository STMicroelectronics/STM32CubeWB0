...
typedef enum
{
  ...
  PROC_GAP_CENTRAL_CONNECT_REQUEST,
...
/** 
  * FIRMWARE ID / Data 
  */
#define  FW_ID_SP_PERIPHERAL    0x8B
#define  FW_ID_SP_PERIPHERAL_D1 0x00
#define  FW_ID_SP_PERIPHERAL_D2 0x00
#define  FW_ID_SP_PERIPHERAL_D3 0x00
