...
#define CFG_ENCRYPTION_KEY_SIZE_MIN         (7)

/**
 * Define IO capabilities
 */
#define CFG_IO_CAPABILITY                   GAP_IO_CAP_KEYBOARD_ONLY
 ...
 */
#define CFG_BLE_NUM_CLT_CONTEXT_MAX                       (0x0001)
