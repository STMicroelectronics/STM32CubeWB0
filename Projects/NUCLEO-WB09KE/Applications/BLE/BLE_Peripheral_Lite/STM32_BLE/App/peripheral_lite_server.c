...
#define PERIPHERAL_LITE_SERVER_UUID 0x8f, 0xe5, 0xb3, 0xd5, 0x2e, 0x7f, 0x4a, 0x98, 0x2a, 0x48, 0x7a, 0xcc, 0x40, 0xfe, 0x0, 0x0
#define LED_C_UUID      0x19, 0xed, 0x82, 0xae, 0xed, 0x21, 0x4c, 0x9d, 0x41, 0x45, 0x22, 0x8e, 0x41, 0xfe, 0x0, 0x0
#define SWITCH_C_UUID   0x19, 0xed, 0x82, 0xae, 0xed, 0x21, 0x4c, 0x9d, 0x41, 0x45, 0x22, 0x8e, 0x42, 0xfe, 0x0, 0x0
...
/* P2P Server LED_C (write without response), SWITCH_C  (notification) characteristics definition */
...
/* Bluetooth LE stack v3.x callback  functions -------------------------------*/
...
void PERIPHERAL_LITE_SERVER_Init(void)
{
  ...
  if (ret != BLE_STATUS_SUCCESS)
  {
    APP_DBG_MSG("  Fail registering service handlers\n");
  } 
