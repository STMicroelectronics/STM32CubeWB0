...
/**
  ******************************************************************************
  * @file    RADIO_TIMER/RADIO_TIMER_Counter/Core/Src/main.c
  * @author  GPM WBL Application Team
  * @brief   This code implements a basic example showing how to use the radio 
  *          timer to trigger periodic wake-up.
  ******************************************************************************
  * @attention
