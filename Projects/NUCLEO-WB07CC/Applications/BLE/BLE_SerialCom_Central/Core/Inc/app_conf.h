...
#define DEVICE_ID                               (0x8D)
#define CFG_L2CAP_CHANNEL_TYPE                  (L2CAP_CHANNEL_TYPE_LE_CFC)
 ...
 */
#define CFG_BLE_NUM_EATT_CHANNELS                       (1)
...
typedef enum
{
  ...
  CFG_TASK_COC_CENTRAL_TX_REQ_ID,
  TASK_BUTTON_1,
  TASK_BUTTON_2,
  TASK_BUTTON_3,
  CFG_TASK_START_SCAN_ID,
  CFG_TASK_CONN_DEV_1_ID,
  CFG_TASK_CENTRAL_SECURITY_REQ_ID,
  CFG_TASK_CENTRAL_CONN_INTERV_UPDATE_ID,  
