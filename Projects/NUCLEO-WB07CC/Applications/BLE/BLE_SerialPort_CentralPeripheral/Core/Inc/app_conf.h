 ...
 */
#define CFG_PUBLIC_BD_ADDRESS               (0x0280E1ACBBAC)
...
typedef enum
{
  ...
  CFG_TASK_PERIPH_SECURITY_REQUEST_ID,
  CFG_TASK_CONNECTION_REQUEST_ID,
  CFG_TASK_WRITE_RX_CHAR_ID,
