      ...
      case HCI_LE_ADVERTISING_REPORT_SUBEVT_CODE:
        {
          ...
          found_status = P2PR_analyseAdvReport(p_adv_report->Advertising_Report.Data_Length, p_adv_report->Advertising_Report.Data_RSSI,
      ...
      case HCI_LE_EXTENDED_ADVERTISING_REPORT_SUBEVT_CODE:
        {
          ...
          found_status = P2PR_analyseAdvReport(p_ext_adv_report->Extended_Advertising_Report.Data_Length, p_ext_adv_report->Extended_Advertising_Report.Data,
                                      ...
                                      uint16_t Supervision_Timeout)
{
  ...
  {
    P2PRHandleNotification.EvtOpcode = P2PR_PERIPH_CONN_HANDLE_EVT;
  }
  else
  {
    P2PRHandleNotification.EvtOpcode = P2PR_CENTR_CONN_HANDLE_EVT;
  }

  P2PRHandleNotification.ConnectionHandle = Connection_Handle;
  P2PR_APP_EvtRx(&P2PRHandleNotification);
    ...
    case AD_TYPE_MANUFACTURER_SPECIFIC_DATA:
      {
        ...
        p_adv_data[i+6] = FW_ID_P2P_ROUTER; /* FW ID */
