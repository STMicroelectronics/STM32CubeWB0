...
/**
 * @brief  Action of button 1 when long pressed, to be implemented by user.
 * @param  None
 * @retval None
 */
__WEAK void APPE_Button1LongPressAction(void)
{
}

/**
 * @brief  Action of button 2 when long pressed, to be implemented by user.
 * @param  None
 * @retval None
 */
__WEAK void APPE_Button2LongPressAction(void)
{
}

/**
 * @brief  Action of button 3 when long pressed, to be implemented by user.
 * @param  None
 * @retval None
 */
__WEAK void APPE_Button3LongPressAction(void)
{
}
#endif
...
static void Button_Init( void )
{
  ...
  UTIL_SEQ_RegTask(1U << TASK_BUTTON_1_LONG_PRESS, UTIL_SEQ_RFU, APPE_Button1LongPressAction);
  UTIL_SEQ_RegTask(1U << TASK_BUTTON_2_LONG_PRESS, UTIL_SEQ_RFU, APPE_Button2LongPressAction);
  UTIL_SEQ_RegTask(1U << TASK_BUTTON_3_LONG_PRESS, UTIL_SEQ_RFU, APPE_Button3LongPressAction);
...
static void Button_TriggerActions(void *arg)
{
  ...
  APP_DBG_MSG("Button %d pressed [longPresses=%d]\n", (p_buttonDesc->button + 1), p_buttonDesc->longPressed);
  switch (p_buttonDesc->button)
  {
    case B1:
      if(p_buttonDesc->longPressed == 0)
      {
      UTIL_SEQ_SetTask(1U << TASK_BUTTON_1, CFG_SEQ_PRIO_0);
      }
      else
      {
        UTIL_SEQ_SetTask(1U << TASK_BUTTON_1_LONG_PRESS, CFG_SEQ_PRIO_0);
      }
      break;
    case B2:
      if(p_buttonDesc->longPressed == 0)
      ...
      {
        UTIL_SEQ_SetTask(1U << TASK_BUTTON_2_LONG_PRESS, CFG_SEQ_PRIO_0);
      }
      break;
    case B3:
      if(p_buttonDesc->longPressed == 0)
      ...
      {
        UTIL_SEQ_SetTask(1U << TASK_BUTTON_3_LONG_PRESS, CFG_SEQ_PRIO_0);
      }
      break;
    default:
      break;
...
static void UartCmdExecute(void)
{
  ...
  if(strcasecmp((char const*)CommandString, "SW1") == 0 || strcasecmp((char const*)CommandString, "1") == 0)
  {
    APP_DBG_MSG("SW1 OK\n");
#if (CFG_BUTTON_SUPPORTED == 1)
  ...
  else if (strcasecmp((char const*)CommandString, "SW2") == 0 || strcasecmp((char const*)CommandString, "2") == 0)
  {
    APP_DBG_MSG("SW2 OK\n");
#if (CFG_BUTTON_SUPPORTED == 1)
  ...
  else if (strcasecmp((char const*)CommandString, "SW3") == 0 || strcasecmp((char const*)CommandString, "3") == 0)
  {
    APP_DBG_MSG("SW3 OK\n");
#if (CFG_BUTTON_SUPPORTED == 1)
  ...
  else if(strcasecmp((char const*)CommandString, "SW1_LONG") == 0 || strcasecmp((char const*)CommandString, "a") == 0)
  {
  ...
  else if (strcasecmp((char const*)CommandString, "SW2_LONG") == 0 || strcasecmp((char const*)CommandString, "s") == 0)
  {
  ...
  else if (strcasecmp((char const*)CommandString, "SW3_LONG") == 0 || strcasecmp((char const*)CommandString, "d") == 0)
  {
    ...
    UTIL_SEQ_SetTask(1U << TASK_BUTTON_3_LONG_PRESS, CFG_SEQ_PRIO_0);
#else
#warning "No cfg button supported"
#endif
  }
  else
  {
