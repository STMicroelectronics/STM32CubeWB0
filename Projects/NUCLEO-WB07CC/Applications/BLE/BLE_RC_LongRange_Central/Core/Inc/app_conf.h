 ...
 */
#define CFG_PUBLIC_BD_ADDRESS               (0x0280E10000E0)
 ...
 */
#define CFG_BLE_NUM_AUX_SCAN_SLOTS                      (3)
...
typedef enum
{
  ...
  CFG_TASK_CONNECT_REQUEST_FIXED_ADDRESS_1M_PHY,
  CFG_TASK_CONNECT_REQUEST_FIXED_ADDRESS_CODED_PHY,
  CFG_TASK_CONNECTION_REQUEST,
  CFG_TASK_WRITE_CHAR_ID,
