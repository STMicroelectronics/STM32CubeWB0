...
SERIALPORT_SERVER_APP_ConnHandleNotEvt_t SERIALPORT_SERVERHandleNotification;

static const char a_GapDeviceName[] = {  'S', 'e', 'r', 'i', 'a', 'l', ' ', 'P', 'o', 'r', 't', ' ', 'S', 'e', 'r', 'v', 'e', 'r' }; /* Gap Device Name */
...
uint8_t a_AdvData[] =
{
  ...
  10, AD_TYPE_COMPLETE_LOCAL_NAME, 'S', 'P', 'o', 'r', 't', 'S', '_', 'X', 'X',  /* Complete name */
  ...
  case HCI_DISCONNECTION_COMPLETE_EVT_CODE:
    {
      ...
      SERIALPORT_SERVERHandleNotification.EvtOpcode = SERIALPORT_SERVER_DISCON_HANDLE_EVT;
      SERIALPORT_SERVERHandleNotification.ConnectionHandle = p_disconnection_complete_event->Connection_Handle;
      SERIALPORT_SERVER_APP_EvtRx(&SERIALPORT_SERVERHandleNotification);
                                      ...
                                      uint16_t Supervision_Timeout)
{
  ...
  SERIALPORT_SERVERHandleNotification.EvtOpcode = SERIALPORT_SERVER_CONN_HANDLE_EVT;
  SERIALPORT_SERVERHandleNotification.ConnectionHandle = Connection_Handle;
  SERIALPORT_SERVER_APP_EvtRx(&SERIALPORT_SERVERHandleNotification);
    ...
    case AD_TYPE_MANUFACTURER_SPECIFIC_DATA:
      {
        ...
        p_adv_data[i+6] = FW_ID_SERIALPORT_SERVER; /* FW ID */
