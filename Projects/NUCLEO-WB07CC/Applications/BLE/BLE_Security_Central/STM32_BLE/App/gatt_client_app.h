...
/* Exported constants --------------------------------------------------------*/
/* USER CODE BEGIN EC */
#define ST_SECURITY_SERVICE_UUID                                           (0xFE40)
#define ST_SECURITY_WRITE_CHAR_UUID                                        (0xFE41)
#define ST_SECURITY_NOTIFY_CHAR_UUID                                       (0xFE42)
#define ST_SECURITY_WRITE_WITH_RES_CHAR_UUID                               (0xFE43)
