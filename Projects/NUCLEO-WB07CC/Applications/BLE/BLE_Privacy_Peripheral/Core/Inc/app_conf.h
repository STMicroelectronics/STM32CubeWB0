...
#define ADV_INTERVAL_MIN                    (0x0101)
...
#define CFG_ENCRYPTION_KEY_SIZE_MAX         (0x10)
#define CFG_ENCRYPTION_KEY_SIZE_MIN         (0x07)
 ...
 */
#define CFG_BLE_NUM_GATT_ATTRIBUTES                     (4)
...
typedef enum
{
  ...
  CFG_TASK_GET_BONDED_DEVICES,
  CFG_TASK_TERMINATE_CONNECTION_AFTER_BONDING,
  CFG_TASK_CONFIGURE_FILTER_LIST_AND_NEW_ADV,
  CFG_TASK_NOTIFICATIONS,
