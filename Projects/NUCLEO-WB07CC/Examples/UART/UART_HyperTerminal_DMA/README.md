...
between a board and an HyperTerminal PC application.
    ...
    Tx Pin: PA9(connected to pin 37 of connector CN3)
    Rx Pin: PA8(connected to pin 35 of connector CN3)
...
NUCLEO-WB07CC board LEDs are used to monitor the transfer status:
