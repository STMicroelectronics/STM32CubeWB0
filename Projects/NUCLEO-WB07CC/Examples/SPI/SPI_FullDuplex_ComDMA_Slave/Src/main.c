...
/**
  ...
  * @brief   This sample code shows how to use STM32WB0x SPI HAL API to transmit
...
{
  /* Turn LD1 on: Transfer in transmission process is complete */
  BSP_LED_On(LD1);
  /* Turn LD2 on: Transfer in reception process is complete */
  BSP_LED_On(LD2);
