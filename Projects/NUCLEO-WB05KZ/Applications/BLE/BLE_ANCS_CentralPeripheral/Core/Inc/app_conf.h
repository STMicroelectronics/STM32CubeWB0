 ...
 */
#define CFG_PUBLIC_BD_ADDRESS               (0x0280E100BCCC)
#define CFG_BD_ADDRESS_TYPE                 HCI_ADDR_PUBLIC
#define CFG_BLE_PRIVACY_ENABLED             (0)

#define ADV_INTERVAL_MIN                    (0x0064)
#define ADV_INTERVAL_MAX                    (0x0078)
...
typedef enum
{
  ...
  CFG_TASK_CHECK_NOTIFICATION_STATE,
  CFG_TASK_GET_ATTR_STATE,
  CFG_TASK_BONDED_STATE,
  CFG_TASK_START_CONNECTION,
  CFG_TASK_NOTIF_ATTR_STATE,
  CFG_TASK_CLIENT_DISCOVER_ANCS,
  CFG_TASK_NOTIFICATION_ANCS,
  CFG_TASK_GATT_CLIENT_BUTTON_1,
  CFG_TASK_GATT_CLIENT_BUTTON_2,
  CFG_TASK_GATT_CLIENT_BUTTON_3,
