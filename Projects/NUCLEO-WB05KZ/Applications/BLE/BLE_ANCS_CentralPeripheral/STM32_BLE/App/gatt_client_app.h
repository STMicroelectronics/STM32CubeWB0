...
typedef enum
{
  ...
  GATT_CLIENT_APP_GET_NOTIFICATION_ATTRIBUTES,
  GATT_CLIENT_APP_GET_NOTIFICATION_ATTRIBUTES_WAITING,
  GATT_CLIENT_APP_GET_NOTIFICATION_ATTRIBUTES_RECEIVED,
  GATT_CLIENT_APP_GET_APP_ATTRIBUTES,
  GATT_CLIENT_APP_GET_APP_ATTRIBUTES_WAITING,
  GATT_CLIENT_APP_GET_APP_ATTRIBUTES_RECEIVED,
  GATT_CLIENT_APP_PERFORM_NOTIFICATION_ACTION,
  GATT_CLIENT_APP_PERFORM_NOTIFICATION_ACTION_WAITING,
  GATT_CLIENT_APP_PERFORM_NOTIFICATION_ACTION_RECEIVED
...
/* Exported constants --------------------------------------------------------*/
#define GATT_CLT_MAX_NUM_SERVERS                           (3)
/* USER CODE BEGIN EC */
