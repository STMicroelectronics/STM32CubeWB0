...
static const char a_GapDeviceName[] = {  'P', 'e', 'e', 'r', ' ', 't', 'o', ' ', 'P', 'e', 'e', 'r', ' ', 'S', 'e', 'r', 'v', 'e', 'r', ' ', 'E', 'x', 't', 'e', 'n', 'd', 'e', 'd' }; /* Gap Device Name */
...
uint8_t a_AdvData[] =
{
  ...
  11, AD_TYPE_COMPLETE_LOCAL_NAME, 'p', '2', 'p', 'S', 'e', 'x', 't', '_', 'X', 'X',  /* Complete name */
