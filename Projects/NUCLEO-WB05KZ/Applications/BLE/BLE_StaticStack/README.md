## __BLE_StaticStack Application Description__
...
_Important_: BLE_p2pServer_StaticStack project by default uses ble_static_stack_sym.a from Binary directory. After generating the new binary, make sure that its symbol table (generated in BLE_StaticStack folder) is referenced by the application.
