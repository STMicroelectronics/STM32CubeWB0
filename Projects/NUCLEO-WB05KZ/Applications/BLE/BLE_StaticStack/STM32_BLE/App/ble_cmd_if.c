...
REQUIRED(void * const cmd_call_table[]) = {
  ...
  (void *) hci_le_read_local_supported_features_page_0,
  ...
  (void *) hci_le_read_remote_features_page_0,
  (void *) hci_le_encrypt,
  (void *) hci_le_rand,
#if (CONTROLLER_MASTER_ENABLED == 1)
...
#endif
  (void *) hci_le_read_all_local_supported_features,
  (void *) hci_le_read_all_remote_features,
  (void *) hci_le_set_host_feature_v2,
#if (CONTROLLER_SCAN_ENABLED == 1)
  (void *) hci_le_add_device_to_monitored_advertisers_list,
  (void *) hci_le_remove_device_from_monitored_advertisers_list,
  (void *) hci_le_clear_monitored_advertisers_list,
  (void *) hci_le_read_monitored_advertisers_list_size,
  (void *) hci_le_enable_monitoring_advertisers,
#endif
