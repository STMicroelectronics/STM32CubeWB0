 ...
 */
#define CFG_BLE_NUM_OF_CONCURRENT_GATT_CLIENT_PROC      (6)
 ...
 */
#define CFG_BLE_NUM_PAWR_SUBEVENTS                      (1)

/**
 * Maximum number of subevent data that can be queued in the controller.
 */
#define CFG_BLE_PAWR_SUBEVENT_DATA_COUNT_MAX            (1U)
 ...
 */
#define CFG_BLE_ATT_QUEUED_WRITE_SIZE                   (0)

/**
 * Amount of RAM used to store GATT services (bytes)
 */
 #define CFG_BLE_GATT_NWK_BUFFER_SIZE                   (256)

/**
 * Amount of RAM used to store advertising data (bytes)
 */
 #define CFG_BLE_ADV_NWK_BUFFER_SIZE                    (512)
