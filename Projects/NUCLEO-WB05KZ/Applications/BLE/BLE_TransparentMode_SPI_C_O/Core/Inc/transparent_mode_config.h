...
#define TM_SPI_MISO_PWR_PIN    (LL_PWR_GPIO_BIT_8) /* SPI MISO PWR PIN */
...
#define TM_SPI_MOSI_PWR_PORT   (LL_PWR_GPIO_A)
#define TM_SPI_MOSI_PWR_PIN    (LL_PWR_GPIO_BIT_11) /* SPI MOSI PWR PIN */
...
#define TM_SPI_SCK_PWR_PIN    (LL_PWR_GPIO_BIT_3) /* SPI SCK PWR PIN */
...
#define TM_SPI_CS_PWR_PIN    (LL_PWR_GPIO_BIT_9) /* SPI CS PWR PIN */
...
#define TM_SPI_MISO_PWR_PIN    (LL_PWR_GPIO_BIT_14) /* SPI MISO PWR PIN */
...
#define TM_SPI_MOSI_PWR_PORT   (LL_PWR_GPIO_A)
#define TM_SPI_MOSI_PWR_PIN    (LL_PWR_GPIO_BIT_15) /* SPI MOSI PWR PIN */
...
#define TM_SPI_SCK_PWR_PIN    (LL_PWR_GPIO_BIT_13) /* SPI SCK PWR PIN */
...
#define TM_SPI_CS_PWR_PIN    (LL_PWR_GPIO_BIT_11) /* SPI CS PWR PIN */
