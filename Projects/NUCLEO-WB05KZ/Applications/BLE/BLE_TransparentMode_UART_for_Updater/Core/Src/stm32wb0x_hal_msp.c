...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART1_MspInit 0 */
    ...
    PA1     ------> USART1_TX
    */
    GPIO_InitStruct.Pin = TM_UART_RX_PIN;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = TM_AF_UART_RX_PIN;
    HAL_GPIO_Init(TM_UART_RX_GPIO_PORT, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = TM_UART_TX_PIN;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = TM_AF_UART_TX_PIN;
    HAL_GPIO_Init(TM_UART_TX_GPIO_PORT, &GPIO_InitStruct);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PA1     ------> USART1_TX
    */
    HAL_GPIO_DeInit(TM_UART_RX_GPIO_PORT, TM_UART_RX_PIN);

    HAL_GPIO_DeInit(TM_UART_TX_GPIO_PORT, TM_UART_TX_PIN);
