...
/**
  ...
  * @note
   ...
   ******************************************************************************
   * 
   * The TransparentMode_UART_for_Updater starts with an offset of 4 KB in Flash memory (2 pages).
   * The 2 initial pages are used by the TransparentMode_UART_Updater project.
   * 
   * The memory layout is the following:
   * 
   * -- FLASH_END ---------------------
   *             
   *   TransparentMode_UART_for_Updater
   * 
   * -- 0x10041000 --------------------
   * 
   *   TransparentMode_UART_Updater
   * 
   * -- 0x10040000 --------------------
   *
   * The TransparentMode_UART_Updater allows to access the Flash memory through ACI_HAL commands.
   * The TransparentMode_UART_Updater can be activated in the following way:
   ...
   *     start of the TransparentMode_UART_Updater. 
   * 
...
static void MX_DMA_Init(void)
{
  ...
  HAL_NVIC_SetPriority(DMA_IRQn, 2, 0);
