...
![latest tag](https://img.shields.io/github/v/tag/STMicroelectronics/STM32CubeWB0.svg?color=brightgreen)
...
The **STM32CubeWB0 MCU Package** projects are directly running on the STM32WB0 series boards. You can find in each Projects/*Board name* directories a set of software projects (Applications/Demonstration/Examples).

## Release note

Details about the content of this release are available in the release note [here](https://htmlpreview.github.io/?https://github.com/STMicroelectronics/STM32CubeWB0/blob/master/Release_Notes.html).
...
```bash
git clone --recursive https://github.com/STMicroelectronics/STM32CubeWB0.git
```
...
```bash
git clone --recursive  --depth 1 --branch vX.Y.Z https://github.com/STMicroelectronics/STM32CubeWB0.git
```
